...
out_ecg = ecg.ecg(signal=ecg_signal, sampling_rate=92., path=ecg_plot_path, interactive=False)
#out_acc = acc(signal=acc_signal, sampling_rate=1000., path=acc_plot_path, interactive=True)
#out_eda = eda.eda(signal=eda_signal, sampling_rate=1000.00, path=eda_plot_path, show=True, min_amplitude=0.1)
