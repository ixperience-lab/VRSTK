...
namespace VRQuestionnaireToolkit
{
    public class Dropdown : MonoBehaviour
    {
        ...
        public List<GameObject> CreateDropdownQuestion(string questionnaireId, string qType, string qInstructions, string qId, string qText, VRSTK.Scripts.JSONArray qOptions, int numberQuestion, RectTransform questionRec)
        {
