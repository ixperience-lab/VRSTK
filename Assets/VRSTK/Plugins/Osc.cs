  ...
  public class Osc 
  {
    ...
    private static int ExtractMessage(ArrayList messages, byte[] packet, int start, int length)
    {
      OscMessage oscM = new OscMessage();
        ...
        //temp[0] = packet[0];
        //temp[2] = packet[1];
        //address += BitConverter.ToChar(temp, 0);
        ...
        //oscM.Values.Add(packet[22]);

        //oscM.Values.Add(packet[23]);
        //oscM.Values.Add(packet[24]);
        //oscM.Values.Add(packet[25]);
        //oscM.Values.Add(packet[26]);

        //short value;
        //temp[0] = packet[27];
        //temp[2] = packet[28];
        //value = BitConverter.ToInt16(temp, 0);
        //oscM.Values.Add(value);
