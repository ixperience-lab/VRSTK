...
namespace VRSTK
{
    namespace Scripts
    {
        ...
        {
            public class CortexBrainComputerInterfaceTraining : MonoBehaviour
            {
                ...
                {
                    Debug.Log("BCITraining: OnCreateProfileOK profilename " + profileName);
                    _isProfileLoaded = true;
                }

                private void OnTrainingOK(object sender, JObject result)
                {
                    Debug.Log("BCITraining:  TrainingOK = " + result);
                    _isSucceeded = true;
                }
