...
namespace VRSTK
{
    namespace Scripts
    {
        ...
        {
            public class CortexTrainedMentalCommandsTest : MonoBehaviour
            {
                ...
                private void OnMentalCommandReceived(object sender, MentalCommandEventArgs mentalCommandEventArgs)
                {
                    ...
                    {
                        Debug.Log("OnMentalCommandReceived: action = " + mentalCommandEventArgs.Act + " power = " + mentalCommandEventArgs.Pow);
                    ...
                    {
                        Debug.Log("OnMentalCommandReceived: Unhandeld mentalcommand!");
                    }
                }

                private void OnProfileLoaded(object sender, string profileName)
                {
                    Debug.Log("BCITraining: OnProfileLoaded profile " + profileName);
