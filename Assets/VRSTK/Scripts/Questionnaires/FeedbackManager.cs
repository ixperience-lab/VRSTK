...
namespace VRQuestionnaireToolkit
{
    ...
    {        
        ...
        public void PulseBothHands(float duration, float frequency, float amplitude)
        {
            try
            {
                OpenXRInput.SendHapticImpulse(_hapticActionLeftHand.action, amplitude, frequency, duration, null); 
                OpenXRInput.SendHapticImpulse(_hapticActionRightHand.action, amplitude, frequency, duration, null);
