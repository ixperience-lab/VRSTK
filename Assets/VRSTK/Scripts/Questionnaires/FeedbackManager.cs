    ...
    namespace Scripts
    {
        namespace Questionnaire
        {
            public class FeedbackManager : MonoBehaviour
            {
                ...
                [Tooltip("Input Action Haptic (RightHand) reference")]
                [SerializeField] private InputActionReference _hapticActionRightHand;

                [Tooltip("Input Action Haptic (LeftHand) reference")]
                [SerializeField] private InputActionReference _hapticActionLeftHand;
                ...
                public void PulseBothHands(float duration, float frequency, float amplitude)
                {
                    try
                    {
                        OpenXRInput.SendHapticImpulse(_hapticActionLeftHand.action, amplitude, frequency, duration, _hapticActionLeftHand.action.activeControl.device);
                        OpenXRInput.SendHapticImpulse(_hapticActionRightHand.action, amplitude, frequency, duration, _hapticActionRightHand.action.activeControl.device);
