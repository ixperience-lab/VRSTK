...
namespace VRQuestionnaireToolkit
{
    public class RadioGrid : MonoBehaviour
    {
        ...
        public List<GameObject> CreateRadioGridQuestion(string questionnaireId, string qType, string qInstructions, string qId, string qText, bool Mandatory, VRSTK.Scripts.JSONArray qOptions, string qConditions, int numberConditions, RectTransform questionRec)
        {
