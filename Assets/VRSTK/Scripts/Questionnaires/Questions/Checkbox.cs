...
namespace VRQuestionnaireToolkit
{
    ...
    public class Checkbox : MonoBehaviour
    {
        ...
        public List<GameObject> CreateCheckboxQuestion(string questionnaireId, string qType, string qInstructions, string qId, string qText, VRSTK.Scripts.JSONArray qOptions, int numberQuestion, RectTransform questionRec)
        {
