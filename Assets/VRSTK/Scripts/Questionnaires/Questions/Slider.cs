...
namespace VRQuestionnaireToolkit
{
    public class Slider : MonoBehaviour
    {
        ...
        public List<GameObject> CreateSliderQuestion(string questionnaireId, string qType, string qInstructions, string qId, string qText, VRSTK.Scripts.JSONArray qOptions, int numberQuestion, RectTransform questionRec, int qMin, int qMax, string qMinxLabel, string qMaxLabel)
        {
