...
namespace VRQuestionnaireToolkit
{
    public class LinearGrid : MonoBehaviour
    {
        ...
        public List<GameObject> CreateLinearGridQuestion(string questionnaireId, string qType, string qInstructions, string qId, string qText, VRSTK.Scripts.JSONArray qOptions, int numberQuestion, RectTransform questionRec, bool qMandatory, int qMin, int qMax, string qMinxLabel, string qMaxLabel)
        {
