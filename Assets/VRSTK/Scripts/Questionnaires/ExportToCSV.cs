                ...
                public void Save()
                {
                    ...
                    for (int i = 0; i < _pageFactory.GetComponent<PageFactory>().QuestionList.Count; i++)
                    {
                        if (_pageFactory.GetComponent<PageFactory>().QuestionList[i] != null)
                        {
                            ...
                            if (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Radio>() != null)
                            {
                                _questionnaireID = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Radio>().QuestionnaireId;
                            ...
                            else if (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<LinearGrid>() != null)
                            {
                                _questionnaireID = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<LinearGrid>().QuestionnaireId;
                                csvTemp[0] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<LinearGrid>().QType;
                                csvTemp[1] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<LinearGrid>().QText;
                                csvTemp[2] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<LinearGrid>().QId;


                                for (int j = 0;
                                    j < _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<LinearGrid>()
                            ...
                            else if (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<RadioGrid>() != null)
                            {
                                _questionnaireID = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<RadioGrid>().QuestionnaireId;
                                csvTemp[0] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<RadioGrid>().QType;
                                csvTemp[1] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<RadioGrid>().QConditions + "_" + _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<RadioGrid>().QText;
                                csvTemp[2] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<RadioGrid>().QId;

                                for (int j = 0;
                                    j < _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<RadioGrid>()
                                        .RadioList.Count;
                                    j++)
                                {
                                    if (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[j].GetComponentInChildren<Toggle>().isOn)
                            ...
                            else if (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Checkbox>() != null)
                            {
                                _questionnaireID = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Checkbox>().QuestionnaireId;

                                for (int j = 0;
                                    j < _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Checkbox>()
                                        .CheckboxList.Count;
                                    j++)
                                {
                                    csvTemp = new string[4];
                                    csvTemp[0] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Checkbox>().QType;
                                    csvTemp[1] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Checkbox>().QText + " -" +
                                                _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[j].GetComponentInParent<Checkbox>().QOptions[j]; // "xxxQuestionxxx? -xxxOptionxxx"
                                    csvTemp[2] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<Checkbox>().QId;
                                    csvTemp[3] = (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[j].GetComponentInChildren<Toggle>().isOn ? ("" + 1) : ""); // 1 if checked, blank if unchecked
                                    _csvRows.Add(csvTemp);
                                }
                            }
                            else if (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Slider>() != null)
                            {
                                _questionnaireID = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Slider>().QuestionnaireId;
                                csvTemp[0] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Slider>().QType;
                                csvTemp[1] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Slider>().QText;
                                csvTemp[2] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Slider>().QId;


                                for (int j = 0;
                                    j < _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Slider>()
                                        .SliderList.Count;
                                    j++)
                                {
                                    csvTemp[3] = "" + _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[j].GetComponentInChildren<UnityEngine.UI.Slider>().value;
                                }
                                _csvRows.Add(csvTemp);
                            }
                            else if (_pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Dropdown>() != null)
                            {
                                _questionnaireID = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Dropdown>().QuestionnaireId;
                                csvTemp[0] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Dropdown>().QType;
                                csvTemp[1] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Dropdown>().QText;
                                csvTemp[2] = _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Dropdown>().QId;


                                for (int j = 0;
                                    j < _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[0].GetComponentInParent<VRQuestionnaireToolkit.Dropdown>()
                                        .DropdownList.Count;
                                    j++)
                                {
                                    csvTemp[3] = "" + _pageFactory.GetComponent<PageFactory>().QuestionList[i].QuestionList[j].GetComponentInChildren<TMP_Dropdown>().value;
                                }
                                _csvRows.Add(csvTemp);
                            }
                        }
