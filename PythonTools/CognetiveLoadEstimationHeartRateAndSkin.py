...
for i in [ 1, 2, 3, 4, 5, 6, 7, 10, 13, 14, 15, 16, 17, 18, 19, 20, 31, 34, 21, 22, 23, 24, 25, 26, 27, 28, 29 ]:
    ...
    plt.figure(figsize=(15,10))
    plt.title("SkinConductance and cognitive load effect")
    width = 0.3
...
plt.figure(figsize=(15,10))
plt.title("SkinConductance and cognitive load effect (conscientious)")
width       = 0.3
plt.boxplot(base_line_filtered_eda_stage_0["FilteredValueInMicroSiemens_scaled"].values.reshape(1, -1)[0], medianprops=dict(color="red"), positions=[0], widths=width)
plt.boxplot(filtered_eda_stage_1["FilteredValueInMicroSiemens_scaled"].values.reshape(1, -1)[0], medianprops=dict(color="blue"), positions=[1], widths=width)
plt.legend()
...
plt.figure(figsize=(15,10))
plt.title("SkinConductance and cognitive load effect (conscientious)")
plt.scatter(range(16), task_values, label="skin conductance (task)", alpha=0.5, marker="o")
plt.legend()
...
plt.figure(figsize=(15,10))
plt.title("SkinConductance and cognitive load effect (non-conscientious)")
width       = 0.3
plt.boxplot(base_line_filtered_eda_stage_0["FilteredValueInMicroSiemens_scaled"].values.reshape(1, -1)[0], medianprops=dict(color="red"), positions=[0], widths=width)
plt.boxplot(filtered_eda_stage_1["FilteredValueInMicroSiemens_scaled"].values.reshape(1, -1)[0], medianprops=dict(color="blue"), positions=[1], widths=width)
plt.legend()
...
plt.figure(figsize=(15,10))
plt.title("SkinConductance and cognitive load effect (no-specifications)")
width       = 0.3
plt.boxplot(base_line_filtered_eda_stage_0["FilteredValueInMicroSiemens_scaled"].values.reshape(1, -1)[0], medianprops=dict(color="red"), positions=[0], widths=width)
plt.boxplot(filtered_eda_stage_1["FilteredValueInMicroSiemens_scaled"].values.reshape(1, -1)[0], medianprops=dict(color="blue"), positions=[1], widths=width)
plt.legend()
