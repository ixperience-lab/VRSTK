...
for(i in 1:nrow(rawEmotivTrackingDataStage0)) {
  ...
  if (!is.null(rowBandPowerValue) && !is.na(rowBandPowerValue) && !is.nan(rowBandPowerValue) && length(rowBandPowerValue) && rowBandPowerValue != "")
  {
    ...
    {
      tempDataFrame <- data.frame("time" = c(as.numeric(rowTimeValue)), 
                                  "AF3/theta" = c(as.numeric(splittedBandPowerValues[2])),  "AF3/alpha" = c(as.numeric(splittedBandPowerValues[3])),  "AF3/betaL" = c(as.numeric(splittedBandPowerValues[4])),  "AF3/betaH" = c(as.numeric(splittedBandPowerValues[5])),  "AF3/gamma" = c(as.numeric(splittedBandPowerValues[6])),
    ...
    else
    {
      row <- c(as.numeric(rowTimeValue), 
               as.numeric(splittedBandPowerValues[2]),  as.numeric(splittedBandPowerValues[3]),  as.numeric(splittedBandPowerValues[4]),  as.numeric(splittedBandPowerValues[5]),  as.numeric(splittedBandPowerValues[6]),
